...
function createTimeline() {
	...
	tlAnim 	.addLabel("start")
			...
			.addLabel("frame5", 12.1)
			.to([logo2, text4], {duration:0.5, autoAlpha:0, ease:"quad.inOut", overwrite:false}, "frame5")
			.to(text4, {duration:1, y:"-=600", ease:"quad.inOut", overwrite:false}, "frame5")
	...
	switch (button) {
		...
		case termsContainer:
			if 		(type === "mouseover") 	{  }
												...
												$e.stopPropagation();
												gsap.to(termsContainer, {duration:0.5, top:600, ease:"power2.inOut", onComplete:function() {
