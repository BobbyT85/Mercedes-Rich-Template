...
function createTimeline() {
	...
	tlAnim 	.addLabel("start")
			.set(ctaButton, {force3D:false, rotationZ:0.01, x:-159, overwrite:false})
			...
			.addLabel("frame2", 3)
			// .to(text1, {duration:0.3, autoAlpha:0, ease:"quad.inOut", overwrite:false}, "frame2")
			...
			.to([soundOffButton, soundOnButton, playButton, pauseButton], {duration:0.3, autoAlpha:0, ease:"quad.inOut", overwrite:false}, "frame5-=0.1")
			.to([logo2, text1, text4], {duration:0.5, autoAlpha:0, ease:"quad.inOut", overwrite:false}, "frame5")
			.to([logo2, text1, text4], {duration:1, x:"-=600", ease:"quad.inOut", overwrite:false}, "frame5")

			.fromTo(text5, {x:"+=200"}, {duration:0.75, x:0, autoAlpha:1, ease:"quad.inOut", overwrite:false}, "frame5+=0.5")
			.fromTo(text6, {x:"+=200"}, {duration:0.75, x:0, autoAlpha:1, ease:"quad.inOut", overwrite:false}, "frame5+=0.55")
			.fromTo(dynamicTerms, {x:"+=200"}, {duration:0.75, x:0, autoAlpha:1, ease:"quad.inOut", overwrite:false}, "frame5+=0.6")
			.call(showCTA, ["-=159"], "frame5+=1.5")
...
function animateCTA() {
	...
	gsap.to(shine, {duration:0.4, delay:0.1, scale:6, force3D:false, rotationZ:0.01, ease:"quad.inOut", overwrite:false});
