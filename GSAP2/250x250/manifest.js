FT.manifest({
  ...
  "videos": [
    // { "name": "video", "ref": "114524/glb_rich_250x250"}
    { "name": "video", "ref": "http://127.0.0.1:5500/250x250/videos/gls_250x250"}
  ],
  ...
  "instantAds": [
    ...
    { "name": "dynamicLogo", "type": "image", "default": "images/logoB_250x250.png" },
    ...
    { "name": "dynamicBackground", "type": "image", "default": "images/poster_250x250.jpg" },
