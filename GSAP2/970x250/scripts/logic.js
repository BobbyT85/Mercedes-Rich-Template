...
function createTimeline() {
	...
	tlAnim 	.addLabel("start")
			...
			.call(function() {
				...
				TweenMax.to(logoA, 0.2, {autoAlpha:1, ease:Quad.easeInOut, overwrite:false});
			...
			.to([text4, logoA], 0.3, {autoAlpha:0, ease:Quad.easeInOut, overwrite:false}, "frame5")
			.set(text4, {x:"-=540"}, "frame5+=0.3")
